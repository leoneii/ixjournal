...
INSERT INTO "sqlite_sequence" VALUES('jtab',48);
CREATE TABLE "jtab" ("npp"	INTEGER,"dat"	TEXT,"numZak"	INTEGER,"phone"	TEXT,"nameZak"	TEXT,"descryption"	TEXT,"costSum"	REAL,"costYN"	BLOB,"prim"	TEXT,"End"	BLOB,);

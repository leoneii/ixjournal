...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setGeometry(QRect(10, 360, 131, 131))
        ...
        self.pushButton_Sprav.setGeometry(QRect(20, 300, 121, 41))
        ...
        self.pushButton_Renew.setGeometry(QRect(10, 580, 131, 41))
        sizePolicy1.setHeightForWidth(self.pushButton_Renew.sizePolicy().hasHeightForWidth())
        self.pushButton_Renew.setSizePolicy(sizePolicy1)
        icon11 = QIcon()
        icon11.addFile(u"image/renew.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_Renew.setIcon(icon11)

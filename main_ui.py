...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u"image/UnFilterAll.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_UnFilter_All.setIcon(icon)
        self.pushButton_UnFilter_All.setIconSize(QSize(28, 28))

        self.gridLayout.addWidget(self.pushButton_UnFilter_All, 1, 0, 1, 4)
        ...
        icon1 = QIcon()
        icon1.addFile(u"image/Filter1.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u"image/UnFilter.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_UnFilter.setIcon(icon2)
        self.pushButton_UnFilter.setIconSize(QSize(28, 28))

        self.gridLayout.addWidget(self.pushButton_UnFilter, 0, 3, 1, 1)

        self.pushButton_notPay = QPushButton(self.groupBox_2)
        self.pushButton_notPay.setObjectName(u"pushButton_notPay")

        self.gridLayout.addWidget(self.pushButton_notPay, 0, 1, 1, 1)
        ...
        self.menu_Quit.addAction(self.actionExit)
        self.menuService.addAction(self.actionSettings)
        self.menuService.addAction(self.action)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_notPay.setText(QCoreApplication.translate("MainWindow", u",,,", None))
        ...
        self.menu_Quit.setTitle(QCoreApplication.translate("MainWindow", u"\u0412\u044b\u0445\u043e\u0434", None))
        self.menuService.setTitle(QCoreApplication.translate("MainWindow", u"\u0421\u0435\u0440\u0432\u0438\u0441", None))
    # retranslateUi

...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon2 = QIcon()
        icon2.addFile(u"image/edit.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"image/remove.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_Del.setIcon(icon3)
        self.groupBox = QGroupBox(self.frame)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setGeometry(QRect(10, 300, 131, 131))
        ...
        icon4 = QIcon()
        icon4.addFile(u"EndWork.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_WorkEnd.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u"image/Payed.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_Pay.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u"image/Moved.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_Ext.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u"image/UnFilter.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_UnFilter.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u"image/UnFilterAll.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_UnFilter_All.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u"image/Exit.jpg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_Exit.setIcon(icon9)
        ...
        self.pushButton_Sprav.setGeometry(QRect(10, 620, 131, 41))
        sizePolicy1.setHeightForWidth(self.pushButton_Sprav.sizePolicy().hasHeightForWidth())
        self.pushButton_Sprav.setSizePolicy(sizePolicy1)
        icon10 = QIcon()
        icon10.addFile(u"image/sprav.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_Sprav.setIcon(icon10)
        self.pushButton_Sprav.setIconSize(QSize(28, 28))
        self.pushButton_Sprav_2 = QPushButton(self.frame)
        self.pushButton_Sprav_2.setObjectName(u"pushButton_Sprav_2")
        self.pushButton_Sprav_2.setGeometry(QRect(10, 580, 131, 41))
        sizePolicy1.setHeightForWidth(self.pushButton_Sprav_2.sizePolicy().hasHeightForWidth())
        self.pushButton_Sprav_2.setSizePolicy(sizePolicy1)
        icon11 = QIcon()
        icon11.addFile(u"image/renew.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_Sprav_2.setIcon(icon11)
        self.pushButton_Sprav_2.setIconSize(QSize(28, 28))
        ...
        self.menubar.setGeometry(QRect(0, 0, 1443, 22))
...
#if QT_CONFIG(tooltip)
        self.pushButton_Sprav_2.setToolTip(QCoreApplication.translate("MainWindow", u"\u0412\u044b\u0439\u0442\u0438  \u0438\u0437 \u043f\u0440\u043e\u0433\u0440\u0430\u043c\u043c\u044b", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_Sprav_2.setText(QCoreApplication.translate("MainWindow", u"\u041e\u0431\u043d\u043e\u0432\u0438\u0442\u044c", None))
